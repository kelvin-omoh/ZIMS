  ...
  return (
    <div className="bg-black bg-opacity-70 w-full h-[500px] md:h-[100vh] top-[90px]">
      ...
      <div className="max-w-[1400px] mx-auto  w-full h-[90%] flex flex-col justify-center text-white px-4 ">
        ...
        <div className="flex">
              <button className="text-md text-white m-2 bg-[#3CCF4E]"><Link to='/tickets'>Normal Ticket</Link></button>
               <button className="text-md text-white m-2"><Link to='/tickets'>Foreigner Tickets</Link></button>
            </div>
      </div>
    </div>
